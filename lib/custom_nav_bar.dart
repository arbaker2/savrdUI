...
class CustomNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NavigationDestinationLabelBehavior effectiveLabelBehavior = labelBehavior
      ?? navigationBarTheme.labelBehavior as NavigationDestinationLabelBehavior?
      ?? defaults.labelBehavior! as NavigationDestinationLabelBehavior;
          ...
          children: <Widget>[
            ...
            AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget? child) {
                ...
                // 100% along a curve.
                final double scale = !_isForwardOrCompleted(animation)
                    ? 0.0
                    : Tween<double>(begin: 0, end: 1.0).transform(
                    CurveTween(curve: Curves.easeIn).transform(animation.value));
              ...
              // direction.
              child: _isForwardOrCompleted(animation)
                     ? selectedIconWidget
...
class _NavigationBarDefaultsM3 extends NavigationBarThemeData {
  _NavigationBarDefaultsM3(this.context)
      : super(
          height: 80.0,
          elevation: 3.0,
          labelBehavior: NavigationDestinationLabelBehavior.alwaysShow as NavigationDestinationLabelBehavior?,
        );
